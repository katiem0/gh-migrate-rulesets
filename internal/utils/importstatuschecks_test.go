...
func TestUpdateStatusCheckIntegrationID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := g.UpdateStatusCheckIntegrationID("targetorg", "sourceorg", tt.ruleset, tt.source)
...
func TestUpdateStatusCheckIntegrationID_NonStatusCheckRuleUntouched(t *testing.T) {
	...
	got := g.UpdateStatusCheckIntegrationID("targetorg", "sourceorg", ruleset, &MockWorkflowGetter{})
