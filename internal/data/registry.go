...
var RuleRegistry = []RuleSpec{
	...
	},
	{
		...
		NonOmitEmpty: []string{"update_allows_fetch_and_merge"},
	},
	{
		Type:      "deletion",
	...
	},
	{
		...
		NonOmitEmpty: []string{"CheckResponseTimeoutMinutes", "GroupingStrategy", "MaxEntriesToBuild", "MaxEntriesToMerge", "MergeType", "MinEntriesToMerge", "MinEntriesToMergeWaitMinutes"},
	},
	{
